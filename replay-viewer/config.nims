...
switch(
  "passL",
  (&"""
  -o {distDir / "cogiavelli_replay.js"}
  -O2
  -s ALLOW_MEMORY_GROWTH
  -s ABORTING_MALLOC=1
  -s ENVIRONMENT=web
  -s MODULARIZE=1
  -s EXPORT_NAME=CogiavelliReplayModule
  -s EXPORTED_RUNTIME_METHODS=HEAPU8
  -s EXPORTED_FUNCTIONS=_main,_malloc,_free,_cog_load_replay,_cog_payload_ptr,_cog_payload_len,_cog_error_ptr,_cog_error_len
  """).replace("\n", " ")
)
