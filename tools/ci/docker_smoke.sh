...
# Substitute: cogiavelli, coworld-cogiavelli, 6.
#
...
#
# env:
#   SMOKE_IMAGE                image, if not given as $1        (coworld-cogiavelli:ci)
#   SMOKE_SLUG                 game slug                        (cogiavelli)
#   SMOKE_GAME_BIN             game entrypoint                  (/bin/cogiavelli)
#   SMOKE_PLAYER_BIN           player entrypoint                (/bin/cogiavelli-player)
...
image="${1:-${SMOKE_IMAGE:-coworld-cogiavelli:ci}}"
slug="${SMOKE_SLUG:-cogiavelli}"
